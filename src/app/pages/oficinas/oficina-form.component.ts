...
export class OficinaFormComponent implements OnInit {
    ...
    private carregarOficina(id: number): void {
        ...
        this.service.get(id).subscribe({
            next: (o: Oficina) => {
                // Preenche apenas campos próprios da Oficina (ignorando carros)
    ...
    salvar(): void {
        ...
        // Não inclui "carros" no payload para não interferir no CRUD de Carro
        const payload: Partial<Oficina> = {
